  ...
  render() {
    if (!this.props.selectedMovie || !this.props.selectedShowing || !this.props.selectedSeats || !this.props.tickets) {
      return (
        <div className="container" style={{backgroundColor: 'rgba(34,34,34,0.3)'}}>
          <NavLink className="arrowleft" to="/booking/tickets"> <i
            className="fas fa-angle-double-left"> </i></NavLink>
          ...
          <NavLink className="arrowright" to="/booking/personal-details"> <i
    ...
    return (
      <div className="container" id="personal-info-box" style={{backgroundColor: 'rgba(34,34,34,0.3)'}}>
        ...
        <NavLink className="arrowleft" to="/personal-details"> <i
          className="fas fa-angle-double-left"> </i></NavLink>
        <button className="option-button" style={{marginTop: '50px'}} onClick={() => {
          ...
          this.props.addPersonalInfo(null);
...
export default connect(mapStateToProps, {confirmBooking, selectSeats, selectShowing, selectTickets, addPersonalInfo})(Confirmation);