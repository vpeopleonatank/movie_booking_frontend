...
import { addPersonalInfo } from '../../actions/bookingActions';
    ...
    render(){
        return (
            <div className="container" id="personal-info-box" style={{backgroundColor: 'rgba(34,34,34,0.3)'}}>
                <NavLink className = "arrowleft" to = "/booking/seats"> <i className = "fas fa-angle-double-left"> </i></NavLink>
                ...
                <NavLink className = "arrowright" to = "/booking/confirmation" > <i className = "fas fa-angle-double-right"> </i></NavLink>
            </div>
        );
    }
}
